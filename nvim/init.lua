...
require("lazy").setup({
	...
	-- Plugin para autocompletado de brackets
	{
	...
	{ -- Autocompletion
		...
		opts = {
			keymap = {
				...
				-- <tab>/ks-tab>: move to right/left of your snippet expansion
...
-- 💾 Guardar sesión manualmente con :Wsave
